    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
       <tr> 
         ...
         <tr> 
		  ...
		  <tr> 
            <td class='bline33' height="26" align="right"><font color='red'>副栏目名称&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
            <td class='bline33'><input name="fulanmu" type="text" id="fulanmu" size="30" value="<?php echo $myrow['fulanmu']?>" class="iptxt" /></td>
          </tr>
            
		  <tr> 
            <td class='bline33' height="26" align="right"><font color='red'>下载地址&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
            <td class='bline33'><input name="xiazai" type="text" id="xiazai" size="30" value="<?php echo $myrow['xiazai']?>" class="iptxt" /></td>
		  </tr>
          	
		  <tr>
            <td height="26" style="padding-left:10px;">栏目图片：</td>
            <td> <input name="lanmuimg" type="text" value="<?php echo $myrow['lanmuimg']?>" id="lanmuimg" class="pubinputs" style="width:300px"/>
             <input type="button" name="Submit" value="浏览..." style="width:70px" onclick="SelectImage('form1.lanmuimg','');">
