...
class ListView
{
    ...
    function CountRecord()
    {
        ...
        if ( defined('DEDEMOB') )
        {
            ...
            $tempfile =str_replace($GLOBALS['cfg_df_style'],'mobile',$tempfile);
        }
     ...
     function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 0)
        {
			if($this->PageNo == 1)
			{
			$prepage.="<a href='".str_replace("{page}",$tnamerule)."'>«</a>\r\n";
			}
			else
			{
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            ...
            $endpage="<a href='".str_replace("{page}",$totalpage,$tnamerule)."'>»»</a>\r\n";
        }
        else
        {
            $nextpage.="<a href='".str_replace("{page}",$tnamerule)."'>»</a>\r\n";
			$endpage="<a>»»</a>\r\n";
        }
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<span class=\"activeLinkWrap\">$j</span>\r\n";
            }
            else
            {
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            ...
            $indexpage="<a href='".$purl."PageNo=1'>««</a>\r\n";
        }
        else
        {
            $indexpage="<a>««</a>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            ...
            $endpage="<a href='".$purl."PageNo=$totalpage'>»»</a>\r\n";
        }
        else
        {
            $endpage="<a>»»</a>\r\n";
